      ...
      <ContLayout>
        <div className={styles.wrap}>
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="异议时间">{ moment(goldEntryDissentOrderDetail.issue_create_time).local().format('YYYY-MM-DD HH:mm:ss') }</Descriptions.Item>
            <Descriptions.Item label="问题类型">{ goldEntryDissentOrderDetail.issue_type }</Descriptions.Item>
            <Descriptions.Item label="问题描述">{ goldEntryDissentOrderDetail.issue_desc }</Descriptions.Item>
            <Descriptions.Item label="平台订单号">{ goldEntryDissentOrderDetail.order_id }</Descriptions.Item>
            <Descriptions.Item label="商户订单号">{ goldEntryDissentOrderDetail.out_order_id }</Descriptions.Item>
            <Descriptions.Item label="承兑商姓名">{ goldEntryDissentOrderDetail.a_user_name }</Descriptions.Item>
            <Descriptions.Item label="币种">{ coinType[goldEntryDissentOrderDetail.token_id] }</Descriptions.Item>
            <Descriptions.Item label="订单金额（USDT）">{ goldEntryDissentOrderDetail.pay_amount }</Descriptions.Item>
            <Descriptions.Item label="订单金额（CNY）">{ goldEntryDissentOrderDetail.pay_amount_cny }</Descriptions.Item>
            <Descriptions.Item label="订单创建时间">{ moment(goldEntryDissentOrderDetail.created_at).local().format('YYYY-MM-DD HH:mm:ss') }</Descriptions.Item>
