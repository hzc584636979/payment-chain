import { Col, Dropdown, Icon, Menu, Row, Button, notification, message, Input, Carousel, Select, Spin } from 'antd';
                        ...
                        <Col xl={12} md={12} sm={24} xs={24}>
                          <div className={styles.itemBox}>
                            ...
                            <div className={styles.item}>
                              ...
                              {tokenBalance1 ? 
                                <span style={{display: 'inline-block', minWidth: 50,color: '#2194FF', textAlign: 'center'}}>{ allBalance - allLockBalance }</span>
                                : 
                                <span style={{display: 'inline-block', minWidth: 50, color: '#333333', textAlign: 'center'}}>****</span>
                              }
                              <span style={{padding: '0 5px'}}>≈</span>
                              {tokenBalance1 ? 
                                <span style={{display: 'inline-block', minWidth: 50, textAlign: 'center'}}>{ ((allBalance - allLockBalance) * currentUser.token_price * currentUser.rate).toFixed(2) }</span>
                                : 
