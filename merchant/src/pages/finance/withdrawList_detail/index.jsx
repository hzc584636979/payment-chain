        ...
        <div className={styles.wrap}>
          <Descriptions column={1}>
            <Descriptions.Item label="订单状态">
              {buyStatusType[withdrawListDetail.state]}
            </Descriptions.Item>
            <Descriptions.Item label="平台订单号">{withdrawListDetail.order_id}</Descriptions.Item>
            <Descriptions.Item label="商户订单号">
              {withdrawListDetail.out_order_id}
            </Descriptions.Item>
            <Descriptions.Item label="付款方式">
              <img src={payIcon[withdrawListDetail.pay_type]} />
            </Descriptions.Item>
            ...
            <Descriptions.Item label="银行名称">
              {withdrawListDetail.account_bank_name}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="代币数量">{withdrawListDetail.pay_amount}</Descriptions.Item>
            <Descriptions.Item label="创建时间">
              {moment(withdrawListDetail.created_at)
                .local()
                .format('YYYY-MM-DD HH:mm:ss')}
            </Descriptions.Item>
            <Descriptions.Item label="转账时间">
              {withdrawListDetail.transfer_time
                ? moment(withdrawListDetail.transfer_time)
                    .local()
                    .format('YYYY-MM-DD HH:mm:ss')
                : EXHIBITION2}
            </Descriptions.Item>
            <Descriptions.Item label="承兑商确认时间">
              {withdrawListDetail.confirm_time
                ? moment(withdrawListDetail.confirm_time)
                    .local()
                    .format('YYYY-MM-DD HH:mm:ss')
                : EXHIBITION2}
            </Descriptions.Item>
