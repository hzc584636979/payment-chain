...
@connect(({ goldYieldOrderAppeal, loading }) => ({
  goldYieldOrderAppeal,
  fetchLoading: loading.effects['goldYieldOrderAppeal/fetch'],
}))
class GoldYieldOrderAppeal extends Component {
  state = {
    loading: false,
    fileList: [],
    type: '',
  ...
  submit = () => {
    ...
    dispatch({
      type: 'goldYieldOrderAppeal/submit',
      payload: {
        issue_file: fileList,
        issue_type: type,
        issue_desc: desc
...
export default GoldYieldOrderAppeal;
