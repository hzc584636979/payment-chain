              ...
              <span>
                {
                  record.state == 1 ?
                  <Fragment>
                    <Button type="primary" onClick={() => this.auditOrder(record.order_id, 1)}>审核通过</Button>
                    <span style={{display: 'inline-block', width: '10px'}}></span>
                    <Button type="danger" onClick={() => this.auditOrder(record.order_id, 2)}>审核不通过</Button>
                    <span style={{display: 'inline-block', width: '10px'}}></span>
                  </Fragment>
                  :
                  record.state == 5 ?
                  <Fragment>
                    <Button type="primary" onClick={() => this.button(record.order_id)}>出金</Button>
                    <span style={{display: 'inline-block', width: '10px'}}></span>
                  </Fragment>
                  :
                  null
