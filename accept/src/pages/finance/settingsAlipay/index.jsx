...
class FinanceSettingsAlipay extends Component {
  ...
  submit = () => {
    ...
    if(!ali_real_name || !ali_pay_number || !ali_payment_qr_code || !ali_pay_payment_link || !telephone_number || !telephone_verify_code){
          ...
          <div className={styles.inner}>
            <Descriptions column={1}>
              ...
              <Descriptions.Item label={<span className={styles.itemLabel}>收码链接</span>}>
                <Input onChange={this.handleLink} style={{width: 385}} placeholder="输入收码链接" value={ali_pay_payment_link} />
              </Descriptions.Item>
