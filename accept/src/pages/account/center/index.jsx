          ...
          <div className={styles.inner}>
            <Descriptions column={1}>
              ...
              <Descriptions.Item label={<span className={styles.itemLabel}>交易密码</span>} className={styles.textTop}>
                <Input type="password" disabled={disabled} onChange={this.handleTx} style={{width: 385}} placeholder="输入交易密码" value={disabled ? 'password' : payment_pwd} maxLength={24} />
