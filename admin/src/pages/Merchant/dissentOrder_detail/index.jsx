      ...
      <ContLayout>
        <div className={styles.wrap}>
          <Descriptions column={1}>
            ...
            <Descriptions.Item label="商户订单号">{ merchantDissentOrderDetail.out_order_id }</Descriptions.Item>
            ...
            <Descriptions.Item label="订单金额">{ `${merchantDissentOrderDetail.pay_amount_cny} ${cashType[merchantDissentOrderDetail.currency_type]}` }</Descriptions.Item>
            <Descriptions.Item label="代币数量">{ `${merchantDissentOrderDetail.pay_amount} ${coinType[merchantDissentOrderDetail.token_id]}` }</Descriptions.Item>
