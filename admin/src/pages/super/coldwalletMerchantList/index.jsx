...
@connect(({ user, coldwalletMerchantList }) => ({
...
class ColdwalletMerchantList extends Component {
  ...
  render() {
    const { coldwalletMerchantList } = this.props;
          ...
          <div className={styles.inner}>
            <Descriptions column={1}>
              ...
              <Descriptions.Item label={''}>
                ...
                <Button>
                  <Link to={`/super/coldwallet/coldwalleMerchant/erc20?address=${123}`}>查账</Link>
                </Button>
              </Descriptions.Item>
              ...
              <Descriptions.Item label={''}>
                ...
                <span style={{padding: '0 10px', color: '#ea8a00', verticalAlign: 'middle',}}>金额：1321 USDT</span>
                <Button>
                  <Link to={`/super/coldwallet/coldwalleMerchant/omni?address=${123}`}>查账</Link>
                </Button>
              </Descriptions.Item>
            </Descriptions>
          </div>
