...
@connect(({ coldwalletAccept, loading }) => ({
  coldwalletAccept,
  loading: loading.effects['coldwalletAccept/fetch'],
}))
@Form.create()
class ColdwalletAccept extends Component {
  state = {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    const { dispatch } = this.props;
    const { history } = this.props.coldwalletAccept.data;
  ...
  render() {
    ...
    const { history, list, pagination } = this.props.coldwalletAccept.data;
    const columns = [
      {
        title: '操作分类',
        dataIndex: 'type',
...
export default ColdwalletAccept;
